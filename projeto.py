...
def open_register():
    ...
    def export_reg_excel():
        ...
        messagebox.showinfo("Exportação concluída" "reinicie o programa e inicie seu registro agora")
...
def main_config_supply():
    ...
    def export_supply_excel():
        ...
        messagebox.showinfo("Registro concluído" "Auditoria salva! Feche o programa.")
...
def main_config_audit():
    ...
    #botão de registro de fornecedor
    audit_register_button = tk.Button(janela_main, text="Registro de Auditoria")
    ...
    #Spec. Testes
    specprod_label = tk.Label(janela_main, text="Spec. Testes:")
    specprod_label.grid(row=8, column=1, padx=10, pady=10, sticky="e")
